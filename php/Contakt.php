...
class Contakt
{
    static public function createContainer(): string
    {
        return
            ...
            '<form action="ProcessContactMail.php" method="post">
                      <div class="atlas-group">
                        <label for="email">E-mail:*</label>
                        <input type="email" id="email" name="visitor_email" class="contactName" placeholder="" required>
                      </div>
                      <div class="atlas-group">
                      ...
                      <div class="atlas-group">
                        ...
                        <input type="text" id="title" name="email_title" class="contactName" required placeholder="" pattern=[A-Za-z0-9\s]{8,60}>
                      </div>
                      <div class="atlas-group">
                        <label for="message">Сообщение:*</label>
                        <textarea id="message" name="visitor_message" class="contactName" placeholder="" required></textarea>
                      </div>'.
                        Navi::submitButton().
                    '</form>' .
            '</div>';
